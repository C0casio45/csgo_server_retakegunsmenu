...
Menu BuildPrimaryMenu()
{
	...
	menu.AddItem("3", "AUG / SG553");
	menu.AddItem("4", "Galil AR / Famas");
	menu.AddItem("5", "UMP-45");
	menu.AddItem("6", "SSG-08");
	...
	if(IsValidClient(client))
	{
		...
		switch(PrimaryChoice[client])
		{
			...
			case 2:
			{
				switch(GetClientTeam(client))
				{
					case CS_TEAM_T:		GivePlayerItem(client, "weapon_sg556");
					case CS_TEAM_CT:	GivePlayerItem(client, "weapon_aug");
				}
			}
			case 3:
			{
			...
			case 4:	GivePlayerItem(client, "weapon_ump45");
			case 5:	GivePlayerItem(client, "weapon_ssg08");
		}
